...
- `scripts/check.ps1`: 전체 545개 테스트, 포맷, 진단 도구와 플러그인 빌드 통과. 빌드 경고·오류 없음.
- 진단 관련 신규 31개 테스트: 미동의·주소 변경·HTTP 차단, 취소, 응답 검증, 부분 수집 실패, ZIP 제한, 실제 HTTP 저장·관리자 인증·중복·용량·만료·신뢰 프록시, 가림 후 재현 결과 보존 확인.
