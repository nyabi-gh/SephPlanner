...
|---|---|---|---|---|
| 커먼 | 18 | 1.50 | 1.50 | 1.00 |
| 언커먼 | 27 | 1.67 | 1.26 | 1.10 |
| 레어 | 26 | 2.00 | 1.67 | 1.25 |
| 레전드 | 11 | 1.47 | 2.11 | 1.45 |

**순서가 서지 않는다.** 레전드의 레벨 0 값어치가 커먼보다 낮다. 그리고 같은 레어도 안의 폭이
레어도 사이의 차이보다 훨씬 크다 — 전체 범위가 상한 기준 `-1.55 ~ 20.00`인데 레어도 배수가
설명하는 폭은 1.0~1.45 뿐이다. 커먼인 압박 밴드가 웬만한 레전드보다 높게 측정된다.
