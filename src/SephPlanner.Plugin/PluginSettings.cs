...
namespace SephPlanner.Plugin
{
    ...
    internal sealed class PluginSettings
    {
        ...
        public PluginSettings(ConfigFile config, Action<string> log, Action reviewDiagnostics)
        {
            ...
            // 패드에는 게임이 안 쓰는 버튼가 하나도 없다. 유일한 빈틈이 게임 창이 떠 있는
            ...
            PadWindow = config.Bind(
                ...
                "게임패드의 View(뒤로) 버튼로 SephPlanner 창을 엽니다. 가방·상자 같은 게임 창이 " +
                "떠 있는 동안에만 듣습니다 - 그때는 이 버튼가 게임에서 아무 일도 하지 않습니다.");
        ...
        public List<OptionRow> Rows()
        {
            return _rows ??= new List<OptionRow>
            {
                ...
                Switch("패드 View 버튼로 창 열기", PadWindow),
