...
{
    /// <summary>패드의 View 단추를 눌렀을 때 창에 할 일.</summary>
    ...
    /// 패드로 창을 여닫을 때인지 가린다.
    ///
    /// <b>게임은 패드 단추를 하나도 남기지 않고 쓴다</b>(docs/RESEARCH.md 의 "패드 단축키").
    /// 키보드의 F 키 같은 빈자리가 없어서, 아무 단추나 잡으면 누를 때마다 게임 동작이 함께
    ...
    /// 떠 있는 동안 이 단추는 게임에서 아무 일도 하지 않는다. 그 조건을 그대로 우리 조건으로
