...
namespace SephPlanner.Core.Solver
{
    ...
    public sealed class CharmWorth
    {
        ...
        /// <summary>
        /// 다섯 칸의 기준값. 측정된 순수 능력치 아티팩트 106종의 분포에서 10·25·50·75·90 분위를
        /// 그대로 가져왔다(1.0.31). 사람이 매기는 등급이라도 칸의 크기는 짐작이 아니어야 한다.
        /// <c>--values</c>가 지금 덤프 기준의 분위를 다시 찍어 주므로 패치 뒤 다시 맞출 수 있다.
        /// <see cref="StatExchange"/>가 눈금을 바꾸면 여기도 같이 움직여야 한다 - 안 그러면
        /// 손값과 레어도 어림값이 측정값과 다른 자로 재는 꼴이 된다.
        /// </summary>
